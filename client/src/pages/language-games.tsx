    ...
    <>
      ...
      <div className="min-h-screen flex flex-col" data-testid="page-language-games">
        ...
        <main className="flex-1 bg-neutral-50">
          {/* Hero Section */}
          <section className="bg-gradient-to-r from-yellow-600 via-orange-500 to-red-700 text-white py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              <p className="text-xl text-yellow-100 mb-8 max-w-3xl mx-auto">
                32+ interactive language games covering vocabulary, grammar, spelling, and reading comprehension
              </p>
