  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col" data-testid="page-language-games">
        ...
        {/* Hero Section */}
        <GameHeroSection 
          title="Language Study Games"
          description="Master vocabulary, grammar, and reading comprehension through engaging language games. Perfect for learners of all levels looking to improve their language skills."
