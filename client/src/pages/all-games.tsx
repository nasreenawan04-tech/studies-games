...
const AllGames = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col" data-testid="page-all-games">
        <Header />
                ...
                <div className="max-w-2xl mx-auto mb-12">
                  <form onSubmit={handleSearch} className="relative">
                    ...
                    <input
                      ...
                      data-testid="input-search-all-games"
                    />
                    <button
                      type="submit"
                      ...
                      data-testid="button-search-all-games"
                    >
          ...
          <section className="py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              {filteredTools.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" data-testid="grid-all-games">
                ...
                <div className="text-center py-16" data-testid="empty-state-no-games">
                  <i className="fas fa-search text-6xl text-neutral-300 mb-4"></i>
                  <h3 className="text-2xl font-bold text-neutral-600 mb-2">No games found</h3>
